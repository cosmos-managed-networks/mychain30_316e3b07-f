...
HTTPS_GIT := github.com/mygithub/mychain30.git
...
ldflags = -X github.com/cosmos/cosmos-sdk/version.Name=mychain30 \
...
ifeq (,$(shell which heighliner))
	...
	heighliner build -c mychain30 --local -f chains.yaml
endif
